...
import { useNetworkStatus } from "@/app/api/useNetworkStatus"
    ...
    <AnimatePresence>
      {!isOnline && (
        ...
        >
          ...
          <span>You&apos;re offline. Weather data may be outdated. Live updates and forecasts will resume once you&apos;re back online.</span>
        </motion.div>
      )}
    </AnimatePresence>
  )
